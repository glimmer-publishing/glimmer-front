...
export default function PublicContract() {
  const listOne = [
    ...
    "Продавець – Фізична особа підприємець Ільчишин Олександра Сергіївна, яка створена і діє відповідно до чинного законодавства України та здійснює господарську діяльність у відповідності до реєстраційних документів.",
  ];
